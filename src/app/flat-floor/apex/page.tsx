...
export default function ApexModelPage() {
        ...
        <div className="flex flex-col items-center justify-center text-center space-y-12 max-w-6xl mx-auto w-full">
          ...
          <div className="w-full space-y-8">
            <h2 className={`text-3xl md:text-5xl font-bold ${transitionClass} ${
              ...
              Peak Performance
              <span className="block text-orange-600 mt-2">Unmatched Durability</span>
            </h2>

            <p className={`text-lg md:text-xl ${transitionClass} ${
              theme === 'dark' ? 'text-gray-400' : 'text-gray-600'
            }`} style={{lineHeight: '1.7'}}>
              The Apex model represents the pinnacle of dump body engineering.
              Premium flat floor design with advanced materials for maximum performance and longevity.
            </p>
          </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className={`font-semibold text-lg mb-2 ${
                    ...
                    Single Sheet Sidewall & Fender
                  </h4>
                  <p className={`text-sm ${transitionClass} ${
                    theme === 'dark' ? 'text-gray-300' : 'text-gray-700'
                  }`}>
                    Innovative single-piece construction provides weight savings and added strength by eliminating seams and joints
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className={`text-lg font-bold ${theme === 'dark' ? 'text-orange-400' : 'text-orange-600'}`}>
                    Apex {selectedGrade.charAt(0).toUpperCase() + selectedGrade.slice(1)}
                  </p>
                </div>
                <div>
          ...
          <div className={`w-full backdrop-blur-sm rounded-xl p-6 ${transitionClass} ${
            theme === 'dark'
              ? 'bg-gradient-to-r from-orange-500/10 to-red-500/10 border-2 border-orange-500/30'
          ...
          <div className="w-full space-y-6 max-w-screen-xl mx-auto">
            <h3 className={`text-2xl md:text-3xl font-bold text-center ${transitionClass} ${
              ...
              Experience the Apex Design
            </h3>
            <p className={`text-center ${transitionClass} ${
              theme === 'dark' ? 'text-gray-400' : 'text-gray-600'
            }`}>
              Explore the Apex model in interactive 3D
            </p>
          ...
          <div className="space-y-6">
            <p className={`text-lg ${transitionClass} ${
              ...
              Ready to order your Apex model?
            </p>
          ...
          <div className={`pt-8 border-t ${transitionClass} ${
            ...
            <p className={`text-sm ${transitionClass} ${
              ...
              Apex Model | Premium Flat Floor Dump Body | Class 7 & Class 8 Compatible
            </p>
          </div>
        </div>
      </div>
