      ...
      <main className={`min-h-screen ${transitionClass} ${
        ...
        <div className="flex flex-col items-center justify-center text-center space-y-12 max-w-6xl mx-auto w-full">
          ...
          <div className={`w-full backdrop-blur-sm rounded-xl p-6 ${transitionClass} ${
            theme === 'dark'
              ? 'bg-gradient-to-r from-blue-500/10 to-green-500/10 border-2 border-blue-500/30'
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className={`text-sm ${
                    ...
                    Discover why our Hardox steel construction provides superior strength and weight savings
                  </p>
                </div>
              </div>
              <Link
